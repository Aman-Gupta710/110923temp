...
public class CheckHotels extends JFrame implements Runnable{
    ...
    JLabel caption;
    public void run(){
        String[] text = new String[]{"Taj Lake,Udaipur","The Oberoi,New Delhi","The Leela Palace,New Delhi","Umaid Bhawan Palace,Jodhpur","Ananda,Himalayas","The Oberoi Grand,Kolkata","Radisson Blu Hotel,Guwahati","Mayflower,Karnatka","Karma Royal,GOA","Palolem Beach Resort,GOA"};
        try{
           for(int i=0;i<= 9;i++){
    ...
    CheckHotels(){
        ...
        for(int i = 0;i <=9;i++){
            image[i]  = new ImageIcon(ClassLoader.getSystemResource("travell/management/system/icons/hotel"+(i+1)+".jpg"));
